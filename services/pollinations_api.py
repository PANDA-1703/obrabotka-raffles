...
- channels — ссылки на каналы, на которые нужно подписаться. В некоторых постах ссылки через md замаскированы под слова (вытаскивай именно ссылку). Если не указано — ставь "н/з".
